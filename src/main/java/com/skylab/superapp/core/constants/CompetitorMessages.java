...
public final class CompetitorMessages {
    ...
    public static final String DELETED_SUCCESS = "competitor.deleted.success";
    public static final String LISTED_SUCCESS = "competitor.listed.success";
    public static final String UPDATED_SUCCESS = "competitor.updated.success";
    public static final String POINTS_ADDED_SUCCESS = "competitor.points.added.success";
    public static final String TENANT_CHECK_FAILED = "competitor.tenant.check.failed";
