...
public final class SeasonMessages {
    ...
    public static final String SEASON_START_DATE_CANNOT_BE_NULL = "season.start.date.cannot.be.null";
    public static final String SEASON_END_DATE_CANNOT_BE_NULL = "season.end.date.cannot.be.null";
    public static final String START_DATE_CANNOT_BE_AFTER_END_DATE = "season.start.date.cannot.be.after.end.date";
    public static final String SEASON_NAME_ALREADY_EXISTS = "season.name.already.exists";
    public static final String SEASON_HAS_RELATED_EVENTS = "season.has.related.events";
}