...
public final class SeasonMessages {
    ...
    public static final String TENANT_CANNOT_BE_NULL = "season.tenant.cannot.be.null";
    public static final String LISTED_SUCCESS = "season.listed.success";
    public static final String COMPETITOR_ALREADY_IN_SEASON = "season.competitor.already.exists";
    public static final String COMPETITOR_ADDED_SUCCESS = "season.competitor.added.success";
    public static final String COMPETITOR_NOT_IN_SEASON = "season.competitor.not.exists";
    public static final String COMPETITOR_REMOVED_SUCCESS = "season.competitor.removed.success";
    public static final String EVENT_ALREADY_EXISTS = "season.event.already.exists";
    public static final String EVENT_ADDED_SUCCESS = "season.event.added.success";
    public static final String EVENT_REMOVED_SUCCESS = "season.event.removed.success";
    public static final String EVENT_NOT_FOUND = "season.event.not.found";
    public static final String EVENT_IS_IN_ANOTHER_SEASON = "season.event.in.another.season";
}