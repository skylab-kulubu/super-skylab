...
@Component
public class EventDaySecurityUtils extends BaseSecurityUtils {

    private static final String RESOURCE = "EVENT_DAY";

    public EventDaySecurityUtils(OpaClient opaClient) {
        super(opaClient);
    }
